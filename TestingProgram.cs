...
class Program
{
    ...
    static void NotMain()
    {
        ...
        // ----------  Draft  ----------
        //Console.WriteLine("abc".CompareTo("aaa"));




        // ---------- Comparing execution time: Assignment and Comparison ----------
        ...
        //    if (a > 10) { }
        //watch.Stop();
        //Console.WriteLine($"Execution Time of Comparison: {watch.ElapsedMilliseconds} ms");
        ...
        //    a = 0;
        //watch.Stop();
        //Console.WriteLine($"Execution Time of Assginment: {watch.ElapsedMilliseconds} ms");
        ...
        //    if (a < 10) a = 0;
        //watch.Stop();
        //Console.WriteLine($"Execution Time of Doing both: {watch.ElapsedMilliseconds} ms");
