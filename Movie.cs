...
public class Movie : IMovie
{
    ...
    //Post-condition:   if the member is not in the borrowers list,
    //                      add the member to the borrower list,
    //                      number of available copies decreases by one,
    //                      number of borrowed times increases by one, and
    //                      return true;
    ...
    //Define how to compare two Movie objects
